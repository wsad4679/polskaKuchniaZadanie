...
import com.example.polskakuchniazadanie.databinding.FragmentMenuChoiceBinding
...
class MenuChoiceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.goToCustomMealButton.setOnClickListener {
            findNavController().navigate(
                MenuChoiceFragmentDirections.actionMenuChoiceFragmentToCustomMealFragment()
            )
        }
        binding.goToReadyMealButton.setOnClickListener {
            findNavController().navigate(
                MenuChoiceFragmentDirections.actionMenuChoiceFragmentToReadyMealFragment()
            )
        }

        binding.goToSummaryButton.setOnClickListener {
            findNavController().navigate(
                MenuChoiceFragmentDirections.actionMenuChoiceFragmentToSummaryFragment()
            )
        }
